...
boolean new_num=0, printer=0, valve=0,pesos=0,litros=0, OK=0, DEL=0, stopCommand=0, mem_address_written=0, ask_litro = 0, ask_peso=0, ask_data=0, ask_state = 0, ask_todo=0, error_status=0, newcommand = 0;
uint8_t mem_address = 0;
boolean dec=0;
uint16_t tx, ty, tz1, tz2;
uint8_t STATE=0;
volatile uint8_t todo_byte = 0, state_byte = 0, error_byte = 0, j=0;
volatile uint8_t ltr_data[4], pes_data[4], uprice_data[2], litro_data[4], client_num[4], time_num[4];
