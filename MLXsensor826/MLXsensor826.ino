...
void loop()
{
  ...
  if (txData[2] < 0x10) Serial.print("0");
  Serial.print(txData[2], HEX);
  if (txData[3] < 0x10) Serial.print("0");
  Serial.print(txData[3], HEX);
  Serial.print("\r");
  ...
  //char data = Serial.read(); // Leer un byte desde Serial
