...
void loop()
{
  ...
  if (millis() - mainRefresh > mainTime)
  {
    ...
    Serial.println(ret);
    ret = i2c_write_blocking(i2c0, 0x5A, &REG_SET_STATUS, 1, false);
    Serial.println(ret);
    ret = i2c_write_blocking(i2c0, 0x5A, buffer, 1, false);
    Serial.println(ret);
    sleep_ms(100);
    ret = i2c_write_blocking(i2c0, 0x5E, &REG_SET_STATUS, 1, true);
    Serial.println(ret);
    ret = i2c_write_blocking(i2c0, 0x5E, buffer, 1, false);
    Serial.println(ret);
